...
import so3POS from "@/mats/so3_POSPAP.jpg";
        ...
        <div className="container mx-auto px-4">
          ...
          <ContentCard title="Presentation & Communication Strategy">
            ...
            <div className="mt-3 flex justify-center">
              <a
                href={`/pdf-viewer?file=${encodeURIComponent(advoPlanPdf)}&title=${encodeURIComponent("Advocacy Plan")}`}
                target="_blank"
            ...
            <ReflectionBox text="Creating the advocacy plan showed me that communication is strategic. Different audiences require different approaches, and effective communicators tailor their messages accordingly. I learned to think about my audience first, then craft messages that would resonate with their values and concerns. This skill is essential for engineers who must often explain technical concepts to non-technical stakeholders." />
          </ContentCard>
        </div>
      </section>
    </PageLayout>
