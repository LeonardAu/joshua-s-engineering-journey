  ...
  return (
    <PageLayout>
      ...
      <Section title="ROTC Lectures">
        ...
        >
          <p>
            The ROTC program includes various lectures on topics ranging from national 
            defense to leadership principles. These sessions required me to absorb and 
            apply new knowledge in areas outside my primary engineering focus.
          </p>
          <ReflectionBox
            text="ROTC lectures demonstrated that learning extends far beyond the classroom and one's primary field of study. I learned to approach unfamiliar topics with openness and to find connections between seemingly unrelated subjects. The discipline and focus required in ROTC translated to better study habits and a more structured approach to acquiring new knowledge in all areas of my life."
          />
        </ContentCard>
      </Section>
      ...
      <section className="py-16 md:py-24 bg-card/50">
        <div className="container mx-auto px-4">
          <h2 className="section-title mb-12">Engineering Student Council - ACADS Team</h2>
          <ContentCard
          ...
          >
            <p>
              As part of the ACADS (Academics) team in the Engineering Student Council, 
              I contributed to creating reviewers and mock exams for fellow engineering 
              students. This required me to deeply understand course materials and 
              present them in accessible formats.
            </p>
            <ReflectionBox
              text="Creating study materials for others is one of the most effective ways to solidify one's own understanding. Through this work, I learned that teaching is a powerful learning strategy. I had to anticipate questions, identify key concepts, and present information clearly. This experience taught me that the best way to learn something is to prepare to teach it to others. As an engineer, I will continuously need to learn new technologies and methods throughout my career, and this experience has equipped me with effective strategies for lifelong learning."
            />
          </ContentCard>
        </div>
      </section>
      ...
      <Section title="Commitment to Lifelong Learning">
        <div className="max-w-3xl mx-auto">
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            Engineering is a rapidly evolving field, and the ability to learn continuously 
            is essential for success. Throughout my academic journey, I have developed 
            strategies for effective learning that will serve me throughout my career.
          </p>
