  ...
  return (
    <PageLayout>
      ...
      <Section title="ROTC Final Exam">
        ...
        >
          <p>
            The ROTC (Reserve Officers' Training Corps) program emphasized teamwork 
            and leadership through various activities and assessments. The final exam 
            component included team-based challenges that required coordination, 
            communication, and collective problem-solving.
          </p>
          <ReflectionBox
            text="ROTC was a powerful lesson in teamwork under pressure. Unlike academic group work, ROTC demanded physical and mental coordination with teammates in challenging situations. I learned that effective teams are built on trust, clear communication, and a shared commitment to the mission. Each member has a role, and success depends on everyone fulfilling their responsibilities while supporting each other. These lessons in teamwork are directly applicable to engineering projects where diverse specialists must collaborate to achieve complex objectives."
          />
        </ContentCard>
      </Section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              {[
                { title: 'Communication', desc: 'Clear and timely information sharing' },
                { title: 'Trust', desc: 'Reliability and mutual support' },
                { title: 'Coordination', desc: 'Synchronized effort toward goals' },
              ].map((item) => (
                <div
                  key={item.title}
