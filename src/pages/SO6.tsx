  ...
  return (
    <PageLayout>
      ...
      <Section title="Chemistry for Engineers Laboratory">
        ...
        >
          <p>
            In the Chemistry for Engineers Laboratory, I conducted various experiments 
            that required careful planning, precise execution, and thorough data analysis. 
            These hands-on experiences reinforced theoretical concepts and developed my 
            experimental skills.
          </p>
          <p className="mt-4">
            The laboratory notebook documents my experimental procedures, observations, 
            and analyses. Additionally, the lab reports demonstrate my ability to 
            communicate experimental findings in a professional format.
          </p>
          <ReflectionBox
            text="Laboratory work taught me the importance of precision, patience, and systematic approach in experimentation. I learned that good data comes from careful methodology, and that unexpected results often lead to the most valuable insights. The experience of analyzing data and drawing conclusions based on evidence has strengthened my scientific reasoning abilities. I now appreciate that experimentation is not just about following procedures but about understanding why each step matters."
          />
        </ContentCard>
      </Section>
      ...
      <section className="py-16 md:py-24 bg-card/50">
        <div className="container mx-auto px-4">
          ...
          >
            <p>
              As part of our Foundation Math Final Project, I conducted experimental 
              testing of a potentiometer's resistance. This involved designing the 
              experiment, collecting data, and analyzing the results to develop a 
